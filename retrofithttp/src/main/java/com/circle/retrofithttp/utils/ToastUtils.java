...
public final class ToastUtils {
    ...
    public static void showNoCancelShort(@NonNull final CharSequence text) {
    ...
    private static void show(final CharSequence text, final int duration, final boolean needCancel) {
        if (text == null) return;
        if (needCancel){
